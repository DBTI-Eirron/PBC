...
frappe.ui.form.on('Adjustment Processing', {
	onload: function(frm){
		//Button Style
		document.querySelectorAll("[data-fieldname='process']")[1].style.backgroundColor ="#81da63";
...
cur_frm.cscript.process = function(doc, cdt, cdn) {
	frappe.show_progress("Processing", 87, 100, "Processing Adjustment");
	...
	return $c('runserverobj', args={'method':'process_adjustment','docs':doc},callback);
}
