...
class EmployeeMovementSetup(Document):
	...
	def validate_duplicate(self):
		ems = frappe.get_all('Employee Movement Setup', filters={'movement_type': self.movement_type})
		if ems:
			for em in ems:
	...
	def create_custom_fields(self):
		...
		if self.movement_type == "Extension of Services":
			movement == "extension_of_Services"
		if self.movement_type == "End of Contract":
			movement == "end_of_contract"
		if self.movement_type == "Job Rotation":
			movement == "job_rotation"
		if self.movement_type == "Salary Adjustment":
			movement == "salary_adjustment"
