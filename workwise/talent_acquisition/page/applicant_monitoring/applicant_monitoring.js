	...
	frappe.call({
		...
		callback: function(r) {
			if (!r.exc && r.message) {
				...
				var ar = r.message.ar;
				page.main.html(frappe.render_template('monitor_section', {candidates:candidates, for_assessment:for_assessment, for_interview:for_interview, job_offer: job_offer, for_employee : for_employee, ar: ar} ));
